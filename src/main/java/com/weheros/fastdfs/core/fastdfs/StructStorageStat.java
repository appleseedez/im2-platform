...
public class StructStorageStat extends StructBase
{
    ...
    protected String                        domainName;                                                          // http
                                                                                                                  // domain
                                                                                                                  // name
    ...
    protected long                          freeMB;                                                              // free
                                                                                                                  ...
                                                                                                                  // in
                                                                                                                  // MB
    protected int                           uploadPriority;                                                      // upload
                                                                                                                  // priority
    protected Date                          joinTime;                                                            // storage
                                                                                                                  // join
                                                                                                                  // timestamp
                                                                                                                  // (create
                                                                                                                  // timestamp)
    protected Date                          upTime;                                                              // storage
                                                                                                                  // service
                                                                                                                  // started
                                                                                                                  // timestamp
    ...
    protected int                           storageHttpPort;                                                     // storage
                                                                                                                  ...
                                                                                                                  // server
                                                                                                                  // port
    protected int                           currentWritePath;                                                    // current
                                                                                                                  // write
                                                                                                                  // path
                                                                                                                  // index
