...
package com.weheros.fastdfs.core.fastdfs;
...
import com.weheros.fastdfs.core.fastdfs.common.Base64;
import com.weheros.fastdfs.core.fastdfs.common.MyException;
import com.weheros.fastdfs.core.fastdfs.common.NameValuePair;
...
public class StorageClient
{
     ...
     *         return null if fail
     */
    protected String[] upload_file(byte cmd, String group_name, String local_filename, String file_ext_name2, NameValuePair[] meta_list) throws IOException, MyException
    {
        String file_ext_name = file_ext_name2;
     ...
     *         return null if fail
     */
    public String[] upload_file(String group_name, String master_filename, String prefix_name, String local_filename, String file_ext_name2, NameValuePair[] meta_list) throws IOException, MyException
    {
        String file_ext_name = file_ext_name2;
        ...
        try
        {
            return this.do_upload_file(ProtoCommon.STORAGE_PROTO_CMD_UPLOAD_SLAVE_FILE, group_name, master_filename, prefix_name, file_ext_name, f.length(), new UploadStream(fis, f.length()),
                    meta_list);
        }
        finally
        {
            ...
            throws IOException, MyException
    {
        ...
        return this.do_upload_file(ProtoCommon.STORAGE_PROTO_CMD_UPLOAD_SLAVE_FILE, group_name, master_filename, prefix_name, file_ext_name, length, new UploadBuff(file_buff, offset, length),
                meta_list);
    }
    ...
    {
        return this.do_upload_file(ProtoCommon.STORAGE_PROTO_CMD_UPLOAD_APPENDER_FILE, group_name, null, null, file_ext_name, file_buff.length, new UploadBuff(file_buff, 0, file_buff.length),
                meta_list);
    }
    ...
    public int download_file(String group_name, String remote_filename, long file_offset, long download_bytes, String local_filename) throws IOException, MyException
    {
        ...
        try
        {
            ...
            try
            {
                ...
                while (remainBytes > 0)
                {
                    bytes = in.read(buff, 0, remainBytes > buff.length ? buff.length : (int) remainBytes);
                    if (bytes < 0)
                    {
    ...
    public int download_file(String group_name, String remote_filename, long file_offset, long download_bytes, DownloadCallback callback) throws IOException, MyException
    {
        ...
        try
        {
            ...
            while (remainBytes > 0)
            {
                ...
                result = callback.recv(header.body_len, buff, bytes);
                if (result != 0)
                {
                    this.errno = (byte) result;
                    return result;
    ...
    public int set_metadata(String group_name, String remote_filename, NameValuePair[] meta_list, byte op_flag) throws IOException, MyException
    {
        ...
        try
        {
            ...
            header = ProtoCommon.packHeader(ProtoCommon.STORAGE_PROTO_CMD_SET_METADATA, 2 * ProtoCommon.FDFS_PROTO_PKG_LEN_SIZE + 1 + groupBytes.length + filenameBytes.length + meta_buff.length,
                    (byte) 0);
            OutputStream out = storageSocket.getOutputStream();
