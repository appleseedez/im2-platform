...
public class TrackerClient
{
     ...
     */
    public StorageServer getStoreStorage(TrackerServer trackerServer2, String groupName) throws IOException
    {
        byte[] header;
        String ip_addr;
        int port;
        ...
        TrackerServer trackerServer = trackerServer2;
    ...
    public StorageServer getFetchStorage1(TrackerServer trackerServer, String file_id) throws IOException
    {
        ...
        this.errno = SupperStorageClient.split_file_id(file_id, parts);
        if (this.errno != 0)
        {
            return null;
        }
