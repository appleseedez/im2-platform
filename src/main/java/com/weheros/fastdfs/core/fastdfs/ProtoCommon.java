...
public class ProtoCommon
{
    ...
    public static final byte   STORAGE_PROTO_CMD_UPLOAD_APPENDER_FILE                  = 23;                                                                               // create
                                                                                                                                                                            // appender
                                                                                                                                                                            // file
    public static final byte   STORAGE_PROTO_CMD_APPEND_FILE                           = 24;                                                                               // append
                                                                                                                                                                            // file
    ...
    public static RecvPackageInfo recvPackage(InputStream in, byte expect_cmd, long expect_body_len) throws IOException
    {
        ...
        {
            bytes = in.read(body, totalBytes, remainBytes);
            if (bytes < 0)
            {
                break;
            }
    ...
    public static String getToken(String remote_filename, int ts, String secret_key) throws UnsupportedEncodingException, NoSuchAlgorithmException, MyException
    {
        ...
        byte[] bsTimestamp = ((Integer) ts).toString().getBytes(ClientGlobal.g_charset);
