...
public class StructGroupStat extends StructBase
{
    ...
    protected String                        groupName;                                                       // name of
                                                                                                              // this
                                                                                                              // group
    protected long                          totalMB;                                                         // total
                                                                                                              // disk
                                                                                                              // storage
                                                                                                              // in MB
    protected long                          freeMB;                                                          // free
                                                                                                              // disk
                                                                                                              // space
                                                                                                              // in MB
    protected long                          trunkFreeMB;                                                     // trunk
                                                                                                              // free
                                                                                                              // space
                                                                                                              // in MB
    protected int                           storageCount;                                                    // storage
                                                                                                              // server
                                                                                                              // count
    protected int                           storagePort;                                                     // storage
                                                                                                              // server
                                                                                                              // port
    protected int                           storageHttpPort;                                                 // storage
                                                                                                              // server
                                                                                                              // HTTP
                                                                                                              // port
    protected int                           activeCount;                                                     // active
                                                                                                              // storage
                                                                                                              // server
                                                                                                              // count
    protected int                           currentWriteServer;                                              // current
                                                                                                              // storage
                                                                                                              // server
                                                                                                              // index
                                                                                                              // to
                                                                                                              // upload
                                                                                                              // file
    protected int                           storePathCount;                                                  // store
                                                                                                              // base
                                                                                                              // path
                                                                                                              // count
                                                                                                              // of each
                                                                                                              // storage
                                                                                                              // server
    protected int                           subdirCountPerPath;                                              // sub dir
                                                                                                              // count
                                                                                                              // per
                                                                                                              // store
                                                                                                              // path
    protected int                           currentTrunkFileId;                                              // current
                                                                                                              // trunk
                                                                                                              // file id
